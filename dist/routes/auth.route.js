...
let AuthRoute = class AuthRoute {
    initializeRoutes() {
        this.router.post(`${this.path}sign-up`, (0, _validationMiddleware.default)(_usersDto.CreateUserDto, 'body'), this.authController.signUp);
        this.router.post(`${this.path}sign-in`, (0, _validationMiddleware.default)(_usersDto.CreateUserDto, 'body'), this.authController.logIn);
        this.router.post(`${this.path}sign-out`, _authMiddleware.default, this.authController.logOut);
    }
    constructor(){
        this.path = '/auth/';
