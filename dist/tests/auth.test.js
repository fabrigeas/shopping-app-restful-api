...
describe('Testing Auth', ()=>{
    describe('[POST] /sign-up', ()=>{
        it('response should have the Create userData', async ()=>{
            ...
            return (0, _supertest.default)(app.getServer()).post(`${authRoute.path}sign-up`).send(userData);
        });
    });
    describe('[POST] /sign-in', ()=>{
        it('response should have the Set-Cookie header with the Authorization token', async ()=>{
            ...
            return (0, _supertest.default)(app.getServer()).post(`${authRoute.path}sign-in`).send(userData).expect('Set-Cookie', /^Authorization=.+/);
        });
    });
});
